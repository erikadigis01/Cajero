    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (jwt != null) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                UserDetails userDetails2 = (UserDetails) userDetails.loadUserByUsername(username);

                if (jwtService.validarToken(jwt, (org.springframework.security.core.userdetails.UserDetails) userDetails2)) {
